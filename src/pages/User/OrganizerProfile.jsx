...
function OrganizerProfile() {
  const organizerId = "655b2a99797a9f9e5ab7975d";
  ...
  return (
    <>
      <div className="h-[92vh] w-[80%] mx-auto mt-10 border-2 border-gray-900 p-10 rounded-lg shadow-sm shadow-slate-800">
        ...
        {/* <div className="mt-6 h-[300px] flex gap-3 ">
          ...
          <div className="ml-3 w-full flex flex-col items-center">
            {Array.from({ length: 3 }, (v, index) => (
              <ProfileEventCard key={index} />
            ))}
            <a className="pt-3 mx-auto underline decoration-secondary hover:text-secondary cursor-pointer hover:-translate-y-1">
              See more...
            </a>
          </div>
        </div> */}

      ...
      <Filter setName={(value) => setName(value)} options={
        {
          inputs: [
            ...
            { label: "Event Date", type: "dateRangePicker", value: eventDate, action: (value) => setEventDate(value), disabled: isUpcoming },
            { label: "Only Upcoming", type: "checkbox", value: isUpcoming, action: () => setIsUpcoming(!isUpcoming)},

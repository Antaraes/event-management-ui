...
export function BoostPayment({
  ...
  const [info, setInfo] = useState({
    ...
    useEffect(() => {
        payment.amount = amount + rangeValue * 20;
    }, [amount, rangeValue]);
  ...
  setInfo((prevInfo) => ({
    ...
    payment: {
      ...prevInfo.payment,
      amount: amount + rangeValue * 20,
      upgradePayment: selectedPaymentId,
    },
  }));

  console.log("Payment", payment);
}, [selectedPaymentId, amount, rangeValue]);
    ...
    >
      ...
      >
              ...
              >
                ...
                >
                  ...
                  <div className="flex justify-between text-black">
                    <Slider
                        value={rangeValue}
                        onChange={(_, newValue) => [setRangeValue(newValue),setAmount(newValue * 20)]}
                  ...
                  <div className="flex justify-between text-black">
                    ...
                    <p className={` r text-[15px]  font-bold`}>${amount}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className=" flex justify-between">
          ...
          <CustomButton onClickFunc={(e) => handleSubmit(e)} title={"Submit"} />
        </div>
      </form>
    </motion.div>
  );

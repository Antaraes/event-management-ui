  ...
  return (
    <section className="w-full bg-center bg-no-repeat bg-[url('https://www.elementalproduction.com/wp-content/uploads/2021/05/corporate-events.jpg')] bg-gray-700 bg-blend-multiply bg-cover">
      <div className="px-4 mx-auto max-w-screen-xl text-center py-16">
        <h1 className="mb-4 text-2xl lg:text-4xl font-bold tracking-tight leading-none text-white">
          FIND YOUR PERFECT SEAT AT EVENTHUB AND BE PART OF THE EXCITING EVENTS
        </h1>
        <p className="mb-8 text-md lg:text-2xl font-semibold text-gray-300 py-10">
        ...
        <div className="relative">
            ...
            <div className="flex absolute right-10 sm:right-16 md:right-24 lg:right-36 xl:right-10 top-0 bottom-0 gap-2 my-2">
                <button className="w-auto bg-slate-100/10 rounded-md px-1 lg:px-3 hover:ring-1 hover:ring-white"><Icon icon="ion:filter" color="white" width="22" /></button>
                <button className="w-auto bg-slate-100/10 rounded-md px-1 lg:px-3 hover:ring-1 hover:ring-white"><Icon icon="iconamoon:search" color="white" width="22"/></button>
            </div>
        </div>
